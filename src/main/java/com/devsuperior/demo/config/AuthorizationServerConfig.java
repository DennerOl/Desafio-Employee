...
/* configuro o authorizationServer para trabalhar com o security
 * 	configuro o token, autenticação usando userDetailsService
 * e também configuro para trabalhar com jwt assinado
 */
	@Bean
	@Order(2)
